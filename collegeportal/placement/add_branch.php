...
if (isset($param)) {
    $arrval = MysqlConnection::fetchByPrimary(MysqlConnection::TBL_BRANCH, $param, "txtId");
}
if (isset($_POST["btnSubmit"])) {
    unset($_POST["btnSubmit"]);
    if ($param) {
        MysqlConnection::edit(MysqlConnection::TBL_BRANCH, $_POST, $param);
    } else {
        MysqlConnection::insert(MysqlConnection::TBL_BRANCH, $_POST);
    }
    header("location:index.php?page=view_branch");
}
?>
        ...
        <div class="page-header">
            <h1>
                <small>
                    ...
                    <a href="index.php?page=view_branch">View Branch</a>
                </small>
            </h1>
        </div><!-- /.page-header -->
        <div class="row">
